...
from backend.app.model.users.users import Users, UsersStatusEnum

# ...  (此处省略了前面的代码，您已经提供的部分...)

DATABASE_URL = "mysql+pymysql://root:Chen0521@nj-cdb-mobsmdsb.sql.tencentcdb.com:63940/test?charset=utf8mb4"
