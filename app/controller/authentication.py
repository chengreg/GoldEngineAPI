...
from app.schema import RegisterByUsernameSchema, RegisterByPhoneNumberSchema
from app.service import register_by_username_service, register_by_phone_number_service
